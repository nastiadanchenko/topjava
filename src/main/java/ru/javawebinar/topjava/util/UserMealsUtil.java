...
public class UserMealsUtil {
    ...
    public static List<UserMealWithExcess> filteredByCycles(List<UserMeal> meals,
        ...
        meals.forEach(m -> sumCalories.merge(m.getDateTime().toLocalDate(), m.getCalories(), Integer::sum));
        ...
        for (UserMeal meal : meals
            ...
            if (TimeUtil.isBetweenHalfOpen(mealTime.toLocalTime(), startTime, endTime)) {
                withExcessList.add(new UserMealWithExcess(meal.getDateTime(),
                        ...
                        sumCalories.get(mealTime.toLocalDate()) > caloriesPerDay));
            }
        }
    ...
    public static List<UserMealWithExcess> filteredByStreams(List<UserMeal> meals,
                                                             ...
                                                             LocalTime endTime,
                                                             int caloriesPerDay) {
        Map<LocalDate, Integer> caloriesSumByData = meals.stream()
        ...
        return meals.stream()
                ...
                .map(um -> new UserMealWithExcess(um.getDateTime(),
                        ...
                        caloriesSumByData.get(um.getDateTime().toLocalDate()) > caloriesPerDay))
